...
static void if_declaration_and_condition_is_missing(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:8: Declaration or condition expected." NEW_LINE, test.source_paths[0]);
}
...
static void elif_declaration_and_condition_is_missing(void)
{
    ...
    format_expectation(&test.expected_error, "%s:6:10: Declaration or condition expected." NEW_LINE, test.source_paths[0]);
}
...
static void if_declaration_but_condition_is_missing(void)
{
    ...
    format_expectation(&test.expected_error, "%s:6:5: Condition expected." NEW_LINE, test.source_paths[0]);
}
...
static void elif_declaration_but_condition_is_missing(void)
{
    ...
    format_expectation(&test.expected_error, "%s:7:5: Condition expected." NEW_LINE, test.source_paths[0]);
}
...
static void if_missing_semicolon_after_declaration(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:18: ; expected after declaration statement." NEW_LINE, test.source_paths[0]);
}
...
static void elif_missing_semicolon_after_declaration(void)
{
    ...
    format_expectation(&test.expected_error, "%s:6:20: ; expected after declaration statement." NEW_LINE, test.source_paths[0]);
}
...
static void missing_end_keyword(void)
{
    ...
    format_expectation(&test.expected_error, "%s:6:1: Missing end keyword in branch." NEW_LINE, test.source_paths[0]);
}
