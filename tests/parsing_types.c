...
static void missing_rhs_square_bracket_in_dynamic_array(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:14: ] expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_rhs_parenthesis_in_function_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:25: ) expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_return_type_in_function_type_without_parameters(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:24: Return type expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_return_type_in_function_type_with_parameters(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:27: Return type expected." NEW_LINE, test.source_paths[0]);
}
