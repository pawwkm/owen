...
static void first_formal_type_parameters_is_a_non_identifer_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:24: Formal type parameter expected." NEW_LINE, test.source_paths[0]);
}
...
static void first_non_identifier_formal_parameter_name(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:28: Formal parameter name expected." NEW_LINE, test.source_paths[0]);
}
...
static void first_non_identifier_formal_parameter_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:24: Formal parameter type expected." NEW_LINE, test.source_paths[0]);
}
...
static void second_non_identifier_formal_parameter_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:31: Formal parameter type expected." NEW_LINE, test.source_paths[0]);
}
...
static void first_non_identifier_return_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:28: Return type expected." NEW_LINE, test.source_paths[0]);
}
...
static void second_non_identifier_return_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:33: Return type expected." NEW_LINE, test.source_paths[0]);
}
...
static void non_identifier_function_name(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:10: Function name expected." NEW_LINE, test.source_paths[0]);
}
...
static void second_formal_type_parameters_is_a_non_identifer_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:27: Formal type parameter expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_right_square_bracket(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:1: ] expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_left_parenthesis(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:12: ( expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_return_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:1: Return type expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_end_keyword(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:1: Missing end keyword in function." NEW_LINE, test.source_paths[0]);
}
