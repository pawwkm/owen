...
static void missing_end_keyword(void)
{
    ...
    format_expectation(&test.expected_error, "%s:8:5: Missing end keyword in for loop." NEW_LINE, test.source_paths[0]);
}
...
static void missing_semicolon_after_condition(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:25: ; expected after condition." NEW_LINE, test.source_paths[0]);
}
...
static void missing_semicolon_after_pre_assignment_statement(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:19: ; expected after declaration statement." NEW_LINE, test.source_paths[0]);
}
...
static void missing_condition(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:20: Condition expected." NEW_LINE, test.source_paths[0]);
}
