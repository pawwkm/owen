...
static void missing_variable_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:12: Variable type expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_variable_name(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:9: Variable name expected." NEW_LINE, test.source_paths[0]);
}
