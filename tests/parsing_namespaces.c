...
static void missing_namespace(void)
{
    ...
    format_expectation(&test.expected_error, "%s:2:1: Namespace declaration expected." NEW_LINE, test.source_paths[0]);
}
...
static void non_identifier_namespace(void)
{
    ...
    format_expectation(&test.expected_error, "%s:2:11: Namespace expected." NEW_LINE, test.source_paths[0]);
}
