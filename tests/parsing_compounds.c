...
static void empty_monomorphic_compound(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:1: Field type expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_first_formal_type_parameter(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:17: Formal type parameter expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_second_formal_type_parameter(void)
{
    ...
    format_expectation(&test.expected_error, "%s:4:20: Formal type parameter expected." NEW_LINE, test.source_paths[0]);
}
...
static void missing_end_keyword(void)
{
    ...
    format_expectation(&test.expected_error, "%s:6:1: Missing end keyword in compound." NEW_LINE, test.source_paths[0]);
}
...
static void invalid_field_type(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:5: Field type expected." NEW_LINE, test.source_paths[0]);
}
...
static void invalid_field_name(void)
{
    ...
    format_expectation(&test.expected_error, "%s:5:9: Field name expected." NEW_LINE, test.source_paths[0]);
}
